...
const pathNames: Record<string, string> = {
  '/admin': 'Pulpit administratora',
  '/admin/setup': 'Setup i seeding',
  ...
  '/admin/settings/oauth': 'Ustawienia OAuth',
  '/admin/import': 'Import & Pipeline',
  '/admin/harvester': 'Import & Pipeline',
