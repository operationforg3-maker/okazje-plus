...
export async function POST(request: NextRequest) {
  try {
    ...
    // Check for duplicates by externalId (Allegro product ID)
    const externalId = product.id || null;
    if (externalId) {
    ...
    console.error('Allegro import error:', error);
    return NextResponse.json(
