...
export const translationInputSchema = z.object({
  ...
  fromLang: z.enum(['pl', 'en', 'de']).describe('Source language'),
  toLangs: z.array(z.enum(['pl', 'en', 'de'])).describe('Target languages'),
});
...
export function ensureLocalizedTitle(
  partialTitle: string | { pl?: string; en?: string; de?: string }
