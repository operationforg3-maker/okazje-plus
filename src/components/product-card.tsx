...
import { 
  ...
  TrendingDown, Award, Clock, Check, Plus, Eye, Scale, Flame, TrendingUp, Sparkles, MoreVertical
} from 'lucide-react';
      ...
      <div className="group relative overflow-hidden rounded-2xl transition-all duration-300 flex flex-col sm:flex-row bg-background/60 backdrop-blur-md p-3 sm:p-4 md:p-5 border border-border/40 items-stretch gap-3 sm:gap-4 md:gap-6 w-full hover:shadow-xl hover:-translate-y-1">
        ...
        <div className="flex flex-col w-full sm:w-48 flex-shrink-0 gap-3 justify-between">
            ...
            <div className="flex gap-2 mt-auto w-full">
              {productExternalUrl ? (
                <Button asChild className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white font-bold h-9 text-xs shadow-sm flex items-center justify-center gap-1">
                ...
                <Button asChild className="flex-1 bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold h-9 text-xs shadow-sm flex items-center justify-center gap-1">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="outline" size="icon" className="h-9 w-9 shrink-0 border-border/80" onClick={(e) => { e.preventDefault(); e.stopPropagation(); }}>
        ...
        <div className="flex items-center gap-1.5 w-full mt-auto pt-2">
          ...
          <div className="flex-1 min-w-0">
            {productExternalUrl ? (
              <Button
                asChild
                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-xs h-9 shadow-sm flex items-center justify-center gap-1 rounded-xl"
              >
                <a
